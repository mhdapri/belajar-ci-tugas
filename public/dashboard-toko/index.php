        ...
        <table class="table text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            // Konversi nilai status menjadi teks dengan badge warna
                            if ($item1->status == 1) {
                                echo '<span class="badge bg-white text-dark">Selesai</span>'; // jika status 1, tampilkan badge hijau
                            } else {
                                echo '<span class="badge bg-white text-dark">Belum Selesai</span>'; // jika status 0, tampilkan badge merah
                            }
                            ?>
                    </td>
                    <td>
